...
class RegistrationSystem:
        ...
        try:
            ...
            self.cursor.execute("""
                CREATE TABLE IF NOT EXISTS Faculty (
                    ...
                    name TEXT NOT NULL,
                    course_preferences TEXT NOT NULL,
    ...
    def assign_course_to_faculty(self,assigned_course,faculty_id):
        try:
            self.connect = sqlite3.connect(self.db_name)
            self.cursor = self.connect.cursor()
            ...
            print(f"An error occurred while adding the course to faculty: {e}")
        finally:
            # Always close the connection at the end
            self.connect.close()
